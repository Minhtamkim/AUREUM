        ...
        <div className="  w-full flex ">
          ...
          <div className="w-full pl-20 gap-x-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Chúng tôi là Công ty AUREUM, vận hành sàn giao dịch thương mại
              điện tử qua website chính thức và tuân thủ các quy định của pháp
              luật Việt Nam.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Khi truy cập website AUREUM, khách hàng đồng ý tuân thủ các điều
              khoản sử dụng. AUREUM có quyền thay đổi, bổ sung nội dung bất kỳ
              lúc nào mà không cần báo trước. Khách hàng có trách nhiệm cập nhật
              thông tin để đảm bảo quyền lợi.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Khách hàng phải đảm bảo thông tin đăng ký chính xác và bảo mật tài
              khoản cá nhân. AUREUM không chịu trách nhiệm đối với các tổn thất
              phát sinh từ việc lộ thông tin đăng nhập.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM có quyền từ chối hoặc hủy đơn hàng nếu phát hiện sai sót về
              giá cả hoặc lỗi hệ thống. Nếu khách hàng đã thanh toán nhưng đơn
              hàng bị hủy, AUREUM sẽ hoàn lại tiền trong thời gian quy định.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM chỉ chấp nhận đổi trả với sản phẩm lỗi do nhà sản xuất hoặc
              hư hỏng trong quá trình vận chuyển theo chính sách đổi trả của
              công ty.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Mọi tranh chấp phát sinh sẽ được giải quyết trên tinh thần hợp
              tác, thương lượng. Nếu không đạt được thỏa thuận, tranh chấp sẽ
