        ...
        <div className="  w-full flex ">
          <div className="w-1/3 border-r pr-4 text-gray-700 px-10">
            <ul className="space-y-2 text-lg">
              ...
              <li className="font-semibold"> Chính sách bảo mật</li>
              <li>
          ...
          <div className="w-full pl-20 gap-x-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM cam kết bảo vệ thông tin khách hàng, đảm bảo an toàn khi
              truy cập và giao dịch trên website.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Khách hàng cần cung cấp thông tin chính xác khi đăng ký tài khoản
              hoặc giao dịch. AUREUM không chịu trách nhiệm nếu thông tin sai
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM cam kết không bán, chia sẻ thông tin cá nhân khách hàng vì
              mục đích thương mại. Hệ thống bảo mật chặt chẽ, phòng chống truy
              cập trái phép. Khách hàng cần bảo mật tài khoản, không chia sẻ
              thông tin cá nhân.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM sử dụng thông tin để cung cấp dịch vụ, hỗ trợ khách hàng,
              ngăn chặn gian lận.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed">
              Chỉ chia sẻ theo quy định pháp luật, phục vụ dịch vụ khách hàng,
              nghiên cứu thị trường. Khách hàng sẽ được thông báo nếu cần chia
              sẻ với bên thứ ba. AUREUM luôn sẵn sàng bảo vệ quyền lợi khách
              hàng với các biện pháp an toàn cao nhất.
            </p>
          </div>
        </div>
      </div>
