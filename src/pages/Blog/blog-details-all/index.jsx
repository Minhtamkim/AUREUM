      ...
      <div className="bg-[#FAF0E8] text-black py-12 px-6 md:px-20">
        <section className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {posts.map((post) => (
              <a key={post.id} onClick={() => navigate(post.path)} className="block group cursor-pointer">
                ...
                <h3 className="text-xl font-bold mt-2 group-hover:text-[#C4B7A6] transition">{post.title}</h3>
