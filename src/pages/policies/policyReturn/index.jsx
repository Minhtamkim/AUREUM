        ...
        <div className="  w-full flex ">
          ...
          <div className="w-full pl-20 gap-x-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM chấp nhận đổi trả trong vòng 7 ngày nếu sản phẩm gặp lỗi từ
              nhà sản xuất, hư hỏng do vận chuyển hoặc sai sót trong đơn hàng.
              Sản phẩm phải còn nguyên vỏ hộp, tem nhãn và chưa qua sử dụng.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              AUREUM không hỗ trợ đổi trả nếu sản phẩm đã quá 7 ngày, đã qua sử
              dụng, mất tem nhãn hoặc không mua từ hệ thống của AUREUM.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Khách hàng liên hệ với AUREUM qua hotline hoặc email để được hướng
              dẫn. Đối với khách tại TP.HCM, có thể đến trực tiếp showroom. Với
              khách ở tỉnh, vui lòng gửi sản phẩm qua bưu điện và cung cấp thông
              tin đơn hàng để được xử lý nhanh nhất.
            </p>
          </div>
        </div>
      </div>
